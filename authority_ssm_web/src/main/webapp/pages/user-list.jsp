...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				User manage <small>All Users</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Homepage</a></li>
				<li><a
					href="${pageContext.request.contextPath}/user/findAll.do">User manage</a></li>
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc sorting_asc_disabled">Mailbox</th>
