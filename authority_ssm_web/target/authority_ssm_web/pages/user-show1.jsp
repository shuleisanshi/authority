...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/index.jsp"><i class="fa fa-dashboard"></i> Homepage</a></li>
                <li><a href="${pageContext.request.contextPath}/user/findAll.do">User manage</a></li>
