...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Role manage <small>Role list</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Homepage</a></li>
				<li><a href="${pageContext.request.contextPath}/role/findAll.do">Role manage</a></li>
			...
			<form action="${pageContext.request.contextPath}/role/save.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">Role Desc</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="roleDesc"
								placeholder="Role Desc" value="">
						</div>
