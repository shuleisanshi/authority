...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Product manage <small>Product form</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Homepage</a></li>
				<li><a
					href="${pageContext.request.contextPath}/product/findAll.do">Product manage</a></li>
			...
			<form action="${pageContext.request.contextPath}/product/save.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">Product order</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productNum"
								placeholder="Product order" value="">
						</div>
