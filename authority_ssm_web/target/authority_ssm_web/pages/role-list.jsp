...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Role manage <small>All roles</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Homepage</a></li>
				<li><a
					href="${pageContext.request.contextPath}/role/findAll.do">Role manage</a></li>
									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/findById.do?id=${role.id}" class="btn bg-olive btn-xs">Details</a>
